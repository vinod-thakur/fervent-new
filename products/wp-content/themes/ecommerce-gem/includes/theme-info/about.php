...
$config = array(
	...
	'quick_links' => array(
		'theme_url' => array(
			...
			'url'  => 'https://promenadethemes.com/downloads/ecommerce-gem/',
			),
		'demo_url' => array(
			'text' => esc_html__( 'View Demo','ecommerce-gem' ),
			'url'  => 'https://promenadethemes.com/demo/ecommerce-gem/',
			),
		'documentation_url' => array(
			'text'   => esc_html__( 'View Documentation','ecommerce-gem' ),
			'url'    => 'https://promenadethemes.com/documentation/ecommerce-gem/',
			),
		'rate_url' => array(
		...
		'pro_url' => array(
			...
			'url'  => 'https://promenadethemes.com/downloads/ecommerce-gem-plus',
			'button' => 'primary',
			),
		),
	...
	'getting_started' => array(
		array(
			...
			'button_link'         => 'https://promenadethemes.com/documentation/ecommerce-gem/',
			'is_button'           => false,
		...
		array(
			...
			'button_link'  			=> 'https://promenadethemes.com/downloads/ecommerce-gem-plus/',
			'is_button'    			=> true,
			'recommended_actions' 	=> false,
			'is_new_tab'   			=> true,
		),
		...
		'first' => array(
			...
			'button_link'  			=> esc_url( 'https://promenadethemes.com/support/item/ecommerce-gem/' ),
			'is_button'    			=> false,
			'recommended_actions' 	=> false,
			'is_new_tab'   			=> true,
		),
